"""Harem Link Bridge — PC companion that opens bot link-buttons in your browser.

Config lives next to the executable (or this package) in ``harem_link_bridge.json``
